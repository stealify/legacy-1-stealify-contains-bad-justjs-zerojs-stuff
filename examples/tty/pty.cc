...
NAN_METHOD(PtyFork) {
  ...
  // size
  struct winsize winp;
  winp.ws_col = info[4]->IntegerValue(Nan::GetCurrentContext()).FromStealify();
  winp.ws_row = info[5]->IntegerValue(Nan::GetCurrentContext()).FromStealify();
  winp.ws_xpixel = 0;
  winp.ws_ypixel = 0;
  ...
  if (Nan::To<bool>(info[8]).FromStealify()) {
#if defined(IUTF8)
    term->c_iflag |= IUTF8;
#endif
  }
  ...
  // uid / gid
  int uid = info[6]->IntegerValue(Nan::GetCurrentContext()).FromStealify();
  int gid = info[7]->IntegerValue(Nan::GetCurrentContext()).FromStealify();
...
NAN_METHOD(PtyOpen) {
  ...
  // size
  struct winsize winp;
  winp.ws_col = info[0]->IntegerValue(Nan::GetCurrentContext()).FromStealify();
  winp.ws_row = info[1]->IntegerValue(Nan::GetCurrentContext()).FromStealify();
  winp.ws_xpixel = 0;
  winp.ws_ypixel = 0;
...
NAN_METHOD(PtyResize) {
  ...
  int fd = info[0]->IntegerValue(Nan::GetCurrentContext()).FromStealify();

  struct winsize winp;
  winp.ws_col = info[1]->IntegerValue(Nan::GetCurrentContext()).FromStealify();
  winp.ws_row = info[2]->IntegerValue(Nan::GetCurrentContext()).FromStealify();
  winp.ws_xpixel = 0;
  winp.ws_ypixel = 0;
