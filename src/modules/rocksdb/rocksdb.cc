...
void stealify::rocksdb::FreeMemory(void* buf, size_t length, void* data) {
  free(buf);
}

void stealify::rocksdb::Close(const FunctionCallbackInfo<Value> &args) {
...
void stealify::rocksdb::Get(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Object> obj = args[0].As<Object>();
  rocksdb_t* db = (rocksdb_t*)obj->GetAlignedPointerFromInternalField(0);
...
void stealify::rocksdb::Delete(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Object> obj = args[0].As<Object>();
  rocksdb_t* db = (rocksdb_t*)obj->GetAlignedPointerFromInternalField(0);
  Local<Object> obj2 = args[1].As<Object>();
...
void stealify::rocksdb::PutString(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Object> obj = args[0].As<Object>();
  rocksdb_t* db = (rocksdb_t*)obj->GetAlignedPointerFromInternalField(0);
  Local<Object> obj2 = args[1].As<Object>();
...
void stealify::rocksdb::Put(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Object> obj = args[0].As<Object>();
  rocksdb_t* db = (rocksdb_t*)obj->GetAlignedPointerFromInternalField(0);
  Local<Object> obj2 = args[1].As<Object>();
...
void stealify::rocksdb::OpenBackupEngine(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
...
void stealify::rocksdb::CreateReadOptions(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Context> context = isolate->GetCurrentContext();
...
void stealify::rocksdb::CreateTableOptions(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Context> context = isolate->GetCurrentContext();
...
void stealify::rocksdb::CreateWriteOptions(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Context> context = isolate->GetCurrentContext();
...
void stealify::rocksdb::DestroyRestoreOptions(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
...
void stealify::rocksdb::DestroyReadOptions(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
...
void stealify::rocksdb::DestroyTableOptions(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
...
void stealify::rocksdb::DestroyWriteOptions(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
...
void stealify::rocksdb::DestroyOptions(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
  rocksdb_options_t* options = (rocksdb_options_t*)obj->GetAlignedPointerFromInternalField(0);
  rocksdb_options_destroy(options);
}

void stealify::rocksdb::CloseBackupEngine(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
  rocksdb_backup_engine_t* be = (rocksdb_backup_engine_t*)obj->GetAlignedPointerFromInternalField(0);
  rocksdb_backup_engine_close(be);
}

void stealify::rocksdb::RestoreFromBackup(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
...
void stealify::rocksdb::CreateRestoreOptions(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Context> context = isolate->GetCurrentContext();
...
void stealify::rocksdb::CreateNewBackup(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj1 = args[0].As<Object>();
  rocksdb_backup_engine_t* be = (rocksdb_backup_engine_t*)obj1->GetAlignedPointerFromInternalField(0);
  Local<Object> obj2 = args[1].As<Object>();
...
void stealify::rocksdb::CreateOptions(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Context> context = isolate->GetCurrentContext();
...
void stealify::rocksdb::IncreaseParallelism(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> obj = args[0].As<Object>();
  rocksdb_options_t* options = (rocksdb_options_t*)obj->GetAlignedPointerFromInternalField(0);
...
void stealify::rocksdb::CreateIfMissing(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Object> obj = args[0].As<Object>();
  rocksdb_options_t* options = (rocksdb_options_t*)obj->GetAlignedPointerFromInternalField(0);
...
void stealify::rocksdb::OptimizeLevelStyleCompaction(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
  rocksdb_options_t* options = (rocksdb_options_t*)obj->GetAlignedPointerFromInternalField(0);
...
void stealify::rocksdb::AllowMmapReads(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
  rocksdb_options_t* options = (rocksdb_options_t*)obj->GetAlignedPointerFromInternalField(0);
...
void stealify::rocksdb::OptimizeUniversalStyleCompaction(const FunctionCallbackInfo<Value> &args) {
  Local<Object> obj = args[0].As<Object>();
  rocksdb_options_t* options = (rocksdb_options_t*)obj->GetAlignedPointerFromInternalField(0);
  Local<BigInt> b64 = args[1].As<BigInt>();
...
void stealify::rocksdb::Open(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> obj = args[0].As<Object>();
  rocksdb_options_t* options = (rocksdb_options_t*)obj->GetAlignedPointerFromInternalField(0);
...
void stealify::rocksdb::Init(Isolate* isolate, Local<ObjectTemplate> target) {
