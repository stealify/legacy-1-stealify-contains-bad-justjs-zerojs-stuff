...
void stealify::pg::Connect(const FunctionCallbackInfo<Value> &args) {
...
void stealify::pg::Exec(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
...
void stealify::pg::SendPrepare(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::SendExecPrepared(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGconn* pq = (PGconn*)database->GetAlignedPointerFromInternalField(0);
...
void stealify::pg::GetResult(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::ConsumeInput(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGconn* pq = (PGconn*)database->GetAlignedPointerFromInternalField(0);
...
void stealify::pg::IsBusy(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGconn* pq = (PGconn*)database->GetAlignedPointerFromInternalField(0);
...
void stealify::pg::SetNonBlocking(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::IsNonBlocking(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGconn* pq = (PGconn*)database->GetAlignedPointerFromInternalField(0);
...
void stealify::pg::Flush(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGconn* pq = (PGconn*)database->GetAlignedPointerFromInternalField(0);
...
void stealify::pg::SetSingleRowMode(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGconn* pq = (PGconn*)database->GetAlignedPointerFromInternalField(0);
...
void stealify::pg::Prepare(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::ExecPrepared(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::GetValue(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::GetType(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::GetSize(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::GetFieldName(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Context> context = isolate->GetCurrentContext();
  Local<Object> database = args[0].As<Object>();
...
void stealify::pg::CommandStatus(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
...
void stealify::pg::ResultStatus(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGresult* result = (PGresult*)database->GetAlignedPointerFromInternalField(1);
...
void stealify::pg::ErrorMessage(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGconn* pq = (PGconn*)database->GetAlignedPointerFromInternalField(0);
...
void stealify::pg::Close(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGconn* pq = (PGconn*)database->GetAlignedPointerFromInternalField(0);
...
void stealify::pg::Clear(const FunctionCallbackInfo<Value> &args) {
  Isolate *isolate = args.GetIsolate();
  HandleScope handleScope(isolate);
  Local<Object> database = args[0].As<Object>();
  PGresult* result = (PGresult*)database->GetAlignedPointerFromInternalField(1);
...
void stealify::pg::Init(Isolate* isolate, Local<ObjectTemplate> target) {
