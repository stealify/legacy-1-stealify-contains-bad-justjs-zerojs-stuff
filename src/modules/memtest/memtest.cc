...
void* stealify::memtest::getBufferData (Local<Value> arg) {
...
void stealify::memtest::ReadOne(const FunctionCallbackInfo<Value> &args) {
...
void stealify::memtest::ReadTwo(const FunctionCallbackInfo<Value> &args) {
...
void stealify::memtest::Init(Isolate* isolate, Local<ObjectTemplate> target) {
