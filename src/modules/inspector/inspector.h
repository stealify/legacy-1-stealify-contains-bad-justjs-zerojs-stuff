#ifndef STEALIFY_INSPECTOR_H
#define STEALIFY_INSPECTOR_H
...
class InspectorClient : public V8InspectorClient {
 public:
  InspectorClient(Local<Context> context, bool connect) {
    ...
    context->Global()->Set(context, function_name, function).FromStealify();
    context_.Reset(isolate_, context);
  }
...
extern "C" {
	void* _register_inspector() {
		return (void*)stealify::inspector::Init;
	}
}
