...
void stealify::sha1::innerHash(unsigned int* result, unsigned int* w)
{
...
void stealify::sha1::shacalc(const char* src, char* hash, int bytelength)
{
...
void stealify::sha1::Hash(const FunctionCallbackInfo<Value> &args) {
...
void stealify::sha1::Init(Isolate* isolate, Local<ObjectTemplate> target) {
